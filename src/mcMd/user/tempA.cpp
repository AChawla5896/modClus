...
namespace McMd
{
   ...
   * Constructor.
   */
   AtomDomain::AtomDomain(System& system)
    : links_(),
      clusters_(),
      workStack_(),
      cellList_(),
   ...
   */
   void
   AtomDomain::initialize(int speciesId, int atomTypeId, double cutoff)
   {
   ...
   */
   void AtomDomain::processNextMolecule(Cluster& cluster)
   {
   ...
   */
   void AtomDomain::identifyClusters()
   {

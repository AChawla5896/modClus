#ifndef HOT_CLUSTER_IDENTIFIER_H
#define HOT_CLUSTER_IDENTIFIER_H
...
namespace McMd
{
   ...
   */
   ...
   public:
      ...
      */
      hotClusterIdentifier(System &system);
   
      /**
      * Destructor.
      */
      ~hotClusterIdentifier();
      ...
      */
      void identifyClusters(DArray <bool> isHot);
   ...
   private:
      ...
      */
      void processNextMolecule(Cluster& cluster, DArray <bool> isHot);
